...
export default function ChooseRole({ theme, onToggleTheme }) {
    return (
        <div className="choose-role">
            ...
            {/* Role cards grid */}
            <section className="choose-role__grid choose-role__grid--three">
                {roles.map(role => (
                    <article
                        key={role.id}
                        className={`role-card ${role.disabled ? 'role-card--disabled' : ''}`}
                        style={{
                    ...
                    >
                        {role.disabled && (
                            <span className="role-card__soon">Coming Soon</span>
                        )}
                        ...
                        {role.disabled ? (
                            <span className="role-card__link role-card__link--soon">
                                {role.linkText}
                            </span>
                        ) : (
